...
public class roulette {
	private static String[] roulette_table = {"0", "red_1", "black_2", "red_3", "black_4", "red_5", "black_6", "red_7", "black_8", "red_9", "black_10",
	...
	protected static String outcome = roulette_table[gen()];
	...
	public static void getValue(GuildMessageReceivedEvent event) {
